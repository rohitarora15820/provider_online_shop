...
class HomeWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var productNotier=Provider.of<ProductNotifier>(context);
                    ...
                    return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return GestureDetector(
                            onTap: (){
                              productNotier.shoeSizes=shoe.sizes;
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    "Latest Shoes",
                    style: appstyle(size:24,color: Colors.black,fw: FontWeight.bold),
                  ),
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                    ...
                    child: Row(
                      children: [
                        Text(
                          "Show All",
                          style: appstyle(size:22,color: Colors.black,fw: FontWeight.w500),
                        ),
                        const Icon(
